...
&& sed -i -e 's@r->headers_out.server == NULL@@g' /tmp/nginx-quic/src/http/ngx_http_header_filter_module.c \
&& sed -i -e 's@r->headers_out.server == NULL@@g' /tmp/nginx-quic/src/http/v2/ngx_http_v2_filter_module.c \
&& sed -i -e 's@r->headers_out.server == NULL@@g' /tmp/nginx-quic/src/http/v3/ngx_http_v3_filter_module.c \
